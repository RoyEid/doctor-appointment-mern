...
function AddDepartment() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#f4fbfc] via-white to-[#eefcff] px-4 py-8 sm:px-6">
      ...
      <div className="mx-auto w-full max-w-lg overflow-hidden rounded-[2rem] border border-white bg-white/95 p-6 shadow-[0_30px_90px_rgba(15,23,42,0.12)] backdrop-blur-xl sm:p-8">
        <div className="mb-7 flex items-center gap-3">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#e8fbfd] text-[#008e9b]">
            <PlusCircle size={30} />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 gap-3 pt-3 sm:grid-cols-[0.8fr_1.2fr]">
            <button
              type="button"
              onClick={() => navigate("/")}
              className="inline-flex items-center justify-center rounded-2xl border border-gray-200 !bg-white px-5 py-4 text-sm font-black text-gray-600 !shadow-none transition-all hover:!bg-gray-50 hover:text-[#008e9b]"
              disabled={loading}
            >
              Cancel
            </button>
      ...
      <p className="mx-auto mt-6 max-w-lg text-center text-sm font-medium text-gray-500">
