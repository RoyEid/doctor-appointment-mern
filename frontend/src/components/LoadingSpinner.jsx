    ...
    >
      <div className="relative flex flex-col items-center justify-center text-center">
        <div className="relative mb-5 flex h-20 w-20 items-center justify-center">
          <div className="absolute inset-0 rounded-full border-4 border-[#dff8fb]" />
          <div className="absolute inset-0 animate-spin rounded-full border-4 border-transparent border-t-[#008e9b] border-r-[#46daea]" />

          <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-[#008e9b] shadow-lg">
            <HeartPulse size={24} className="animate-pulse" />
          </div>
        </div>

        <p className="text-sm font-black uppercase tracking-[0.18em] text-[#008e9b]">
          Please wait
        </p>
