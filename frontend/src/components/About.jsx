      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-3xl font-black tracking-tight text-gray-900 md:text-5xl">
            About <span className="text-[#008e9b]">Us</span>
          </h2>
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="group relative overflow-hidden rounded-[2rem] border border-white bg-white shadow-[0_24px_70px_rgba(15,23,42,0.12)]">
            <img
              src={AboutUs}
              alt="About MediCare"
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/25 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              <a
                ...
                className="flex h-20 w-20 items-center justify-center rounded-full bg-white text-[#008e9b] shadow-2xl transition-transform hover:scale-110"
          ...
          <div className="rounded-[2rem] border border-white bg-white/90 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:p-8">
            <h3 className="text-2xl font-black leading-tight text-gray-900 lg:text-3xl">
              Trusted healthcare services with skilled professionals and
              advanced technology.
            </h3>

            <div className="my-7 rounded-3xl border border-[#008e9b]/10 bg-[#e8fbfd] p-6">
              <p className="font-semibold italic leading-relaxed text-[#007a85]">
            ...
            <ul className="space-y-4 text-gray-700">
              {[
                ...
                <li key={item} className="flex items-start gap-3">
                  <span className="mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[#e8fbfd] text-sm font-black text-[#008e9b]">
                    ✓
                  </span>
